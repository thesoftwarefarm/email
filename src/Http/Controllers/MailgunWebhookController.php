...
class MailgunWebhookController
{
    ...
    private function processComplainedEvent($event, EmailModel $email)
    {
        ...
        event(new EmailComplained($email, eventPayload: $event));
    ...
    {
        event(new EmailUnsubscribed($email, eventPayload: $event));
    ...
    {
        event(new EmailClicked($email, eventPayload: $event));
    ...
    {
        event(new EmailOpened($email, eventPayload: $event));
    ...
    private function processDeliveredEvent($event, EmailModel $email)
    {
        ...
        event(new EmailDelivered($email, eventPayload: $event));
    ...
    private function processFailedEvent($event, EmailModel $email)
    {
        ...
        event(new EmailFailed($email, eventPayload: $event));
